...
select
    counting_user_phone.*,
    counting_reported_registration.reported_registration
from counting_user_phone
left join counting_reported_registration on counting_reported_registration.created_on = counting_user_phone.user_registered_on
order by user_registered_on desc