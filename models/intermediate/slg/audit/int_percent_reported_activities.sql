...
select
    count(distinct joining_tables.dost_member_name)/count(distinct members_reported_activities.dost_member_name) as percent_reported
from members_reported_activities
left join joining_tables using (dost_member_name)